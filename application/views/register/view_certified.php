            ...
            <tbody>
                ...
                foreach ($ofertas as $oferta) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo base_url('ofertas/informacion/' . 'UMB2014' . str_pad($oferta->EMPLEO_ID, 4, "0", STR_PAD_LEFT)) ?>" style="margin-left: 5px;" class="label label-default">
                                <?php echo 'UMB2014' . str_pad($oferta->EMPLEO_ID, 4, "0", STR_PAD_LEFT); ?>
