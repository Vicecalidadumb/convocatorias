...
//echo print_y($this->session->userdata('politicas'));
    ...
    <div class="jumbotron">
        ...
        <p style="font-size: 15px !important; text-align: justify !important;">
            ...
            <strong>(2) megabytes (MB)</strong>.  El cargue de  documentos, se har&aacute;  &uacute;nicamente por medio electr&oacute;nico desde el dia 
            <strong>2014-09-26</strong>, se habilitar&aacute; el sistema para tal fin  a partir de las ocho de la noche (20:00).
            <br><br>
